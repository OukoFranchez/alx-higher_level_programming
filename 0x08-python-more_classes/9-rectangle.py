#!/usr/bin/python3
"""This module provides class for task 9
classes:
...
class Rectangle:
    ...
    def __del__(self):
        """
        Print a message when an instance of the
        Rectangle gets deleted
        """
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
    ...
    def square(cls, size=0):
        """
        create new square rectangle instance with equal width
        and height
        """
